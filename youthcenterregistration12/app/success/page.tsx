  ...
  if (!member) {
    return (
      <div className="w-full min-h-screen flex flex-col gap-8 items-center justify-center">
        <div className="max-w-md mx-auto shadow-2xl border-0 bg-white/95 dark:bg-gray-900/80 backdrop-blur-sm rounded-2xl">
  ...
  return (
    <div className="w-full min-h-screen flex flex-col gap-8">
      <main className="container mx-auto px-4 py-8">
        <div className="max-w-2xl mx-auto mb-8 shadow-2xl border-0 bg-white/95 dark:bg-gray-900/80 backdrop-blur-sm rounded-2xl">
          <div className="text-center bg-gradient-to-r from-green-50 to-blue-50 rounded-t-2xl p-8">
            <CheckCircle className="w-16 h-16 text-green-600 mx-auto mb-4" />
            <h2 className="text-2xl text-green-800 font-bold">تم التسجيل بنجاح!</h2>
          </div>
          <div className="p-8">
