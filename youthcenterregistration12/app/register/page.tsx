...
import wilayasData from "@/lib/wilayas-baladiyas.json"
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="text-right">
                ...
                <p className="text-sm text-gray-600 flex items-center gap-1">رحلة التسجيل الذكية</p>
              </div>
            </div>
          </div>
        </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="space-y-3">
                  ...
                  <Select
                    ...
                    onValueChange={(wilaya) => {
                      handleInputChange("birthPlace", { ...formData.birthPlace, wilaya, commune: "" });
                    }}
                  >
                    <SelectTrigger>
                ...
                <div className="space-y-3">
                  ...
                  <Select
                    ...
                    onValueChange={(commune) => {
                      handleInputChange("birthPlace", { ...formData.birthPlace, commune });
                    }}
                    disabled={!formData.birthPlace.wilaya}
                  >
                    <SelectTrigger>
                      <SelectValue placeholder="اختر البلدية" />
                    </SelectTrigger>
                    <SelectContent>
                      {(wilayasData.find((w: any) => w.name === formData.birthPlace.wilaya)?.baladiyas || []).map((baladiya: string) => (
