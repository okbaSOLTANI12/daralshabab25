...
export default function StatisticsPage() {
  ...
  const calculateStatistics = (membersData: Member[]): Statistics => {
    ...
    // Age groups - UPDATED to match lib/utils.ts and lib/excel-export.ts
    const ageGroups = ["5-15", "16-22", "23-29", "30+"].reduce(
      (acc, ageGroup) => {
    ...
    <div className="w-full min-h-screen flex flex-col gap-8">
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <Card className="border-0 shadow-xl bg-white/95 dark:bg-gray-900/80 backdrop-blur-sm rounded-2xl text-white">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2 bg-gradient-to-br from-blue-500 to-blue-600 rounded-t-2xl">
          ...
          <Card className="border-0 shadow-xl bg-white/95 dark:bg-gray-900/80 backdrop-blur-sm rounded-2xl text-white">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2 bg-gradient-to-br from-green-500 to-green-600 rounded-t-2xl">
          ...
          <Card className="border-0 shadow-xl bg-white/95 dark:bg-gray-900/80 backdrop-blur-sm rounded-2xl text-white">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2 bg-gradient-to-br from-pink-500 to-pink-600 rounded-t-2xl">
          ...
          <Card className="border-0 shadow-xl bg-white/95 dark:bg-gray-900/80 backdrop-blur-sm rounded-2xl text-white">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2 bg-gradient-to-br from-purple-500 to-purple-600 rounded-t-2xl">
        ...
        <Card className="mb-8 shadow-xl border-0 bg-white/95 dark:bg-gray-900/80 backdrop-blur-sm rounded-2xl">
                  ...
                  {Object.entries(statistics.ageGroups).map(([ageGroup, data]) => (
                    <tr key={ageGroup} className="hover:bg-gray-50 transition-colors">
                      <td className="border-2 border-gray-300 px-6 py-4 font-medium bg-gray-50">
                        {/* UPDATED age group labels */}
                        {ageGroup === "5-15" && "من 5 إلى 15 سنة"}
                        {ageGroup === "16-22" && "من 16 إلى 22 سنة"}
                        {ageGroup === "23-29" && "من 23 إلى 29 سنة"}
                        {ageGroup === "30+" && "30 سنة فما فوق"}
                      </td>
        ...
        <Card className="shadow-xl border-0 bg-white/95 dark:bg-gray-900/80 backdrop-blur-sm rounded-2xl">
                        ...
                        return (
                          <tr key={ageGroup} className="hover:bg-gray-50">
                            <td className="border border-gray-300 px-3 py-2 font-medium bg-gray-50">
                              {/* UPDATED age group labels */}
                              {ageGroup === "5-15" && "5-15 سنة"}
                              {ageGroup === "16-22" && "16-22 سنة"}
                              {ageGroup === "23-29" && "23-29 سنة"}
                              {ageGroup === "30+" && "30+ سنة"}
                            </td>
