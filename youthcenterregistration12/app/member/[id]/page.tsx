    ...
    <div className="w-full min-h-screen flex flex-col gap-8">
      <main className="container mx-auto px-4 py-8">
        <div className="shadow-2xl border-0 bg-white/95 dark:bg-gray-900/80 backdrop-blur-sm rounded-2xl">
          <div className="bg-gradient-to-r from-green-600 to-blue-600 text-white rounded-t-2xl p-6 flex items-center gap-4">
            <h2 className="text-2xl font-bold">تفاصيل المنخرط</h2>
            <p className="text-green-100 text-lg">عرض وإدارة بيانات المنخرط</p>
          </div>
          <div className="p-6">
            {/* Action Buttons */}
