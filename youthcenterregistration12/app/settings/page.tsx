    ...
    <div className="w-full min-h-screen flex flex-col gap-8">
      <main className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          {/* Member ID Settings */}
          <div className="shadow-xl border-0 bg-white/95 dark:bg-gray-900/80 backdrop-blur-sm rounded-2xl">
            <div className="bg-gradient-to-r from-green-600 to-blue-600 text-white rounded-t-2xl p-6">
              ...
              <p className="text-green-100 mt-1">إدارة عداد الأرقام التعريفية للمنخرطين</p>
            </div>
          ...
          <div className="shadow-xl border-0 bg-white/95 dark:bg-gray-900/80 backdrop-blur-sm rounded-2xl">
            <div className="bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-t-2xl p-6">
              ...
              <p className="text-purple-100 mt-1">تحديد نطاق أرقام بطاقات الانخراط</p>
            </div>
            <div className="space-y-6 p-6">
          ...
          <div className="shadow-xl border-0 bg-white/95 dark:bg-gray-900/80 backdrop-blur-sm rounded-2xl">
            <div className="bg-gradient-to-r from-red-600 to-orange-600 text-white rounded-t-2xl p-6">
              ...
              <p className="text-red-100 mt-1">حذف جميع بيانات المنخرطين</p>
            </div>
            <div className="space-y-6 p-6">
          ...
          {/* System Information */}
          <div className="shadow-xl border-0 bg-white/95 dark:bg-gray-900/80 backdrop-blur-sm rounded-2xl">
            <div className="bg-gradient-to-r from-gray-600 to-gray-700 text-white rounded-t-2xl p-6">
              <h2 className="flex items-center gap-2 text-xl font-bold">
