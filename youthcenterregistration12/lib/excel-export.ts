...
export function exportStatisticsToExcel(members: Member[]) {
  ...
  // الصف الأول: العنوان الرئيسي (كما في الصورة)
  wsData.push([
  ...
  ws["!merges"] = [
    // العنوان الرئيسي - الجمهورية
    { s: { r: 0, c: 0 }, e: { r: 0, c: 21 } },
    // العنوان الثاني - وزارة الشباب
    { s: { r: 1, c: 0 }, e: { r: 1, c: 21 } },
    // العنوان الفرعي - بطاقة إحصائية
    { s: { r: 3, c: 0 }, e: { r: 3, c: 21 } },
    // عناوين الأعمدة الرئيسية
    { s: { r: 5, c: 0 }, e: { r: 6, c: 0 } }, // النشاطات
    { s: { r: 5, c: 1 }, e: { r: 6, c: 1 } }, // الفضاءات
    { s: { r: 5, c: 2 }, e: { r: 5, c: 4 } }, // عدد المنخرطين
    { s: { r: 5, c: 5 }, e: { r: 6, c: 5 } }, // عدد النوادي
    { s: { r: 5, c: 6 }, e: { r: 5, c: 17 } }, // الفئات العمرية (12 أعمدة: 4 فئات × 3 أعمدة)
    { s: { r: 5, c: 18 }, e: { r: 6, c: 18 } }, // المجموع العام
    { s: { r: 5, c: 19 }, e: { r: 6, c: 19 } }, // عدد الجمعيات الشريكة
  ];
  ...
  // تعيين عرض الأعمدة لضمان ظهور النص كاملاً
  ws["!cols"] = [];
  for (let i = 0; i < 22; i++) {
    ws["!cols"][i] = { width: 15 };
  }
  // تعيين عرض أكبر للعمود الأول (النشاطات)
  ws["!cols"][0] = { width: 25 };
  ws["!cols"][1] = { width: 20 };
