  ...
  return `
    ...
    <body>
      <div class="id-card">
        ...
        <div class="id-title">بطاقة الانخراط</div>
        <div class="id-content">
          <img src="${photoBase64}" alt="صورة المنخرط" class="id-photo" onerror="this.style.display='none'">
          <div class="id-info">
            <div><span class="id-label">الاسم:</span><span class="id-value">${member.first_name} ${member.last_name}</span></div>
            <div><span class="id-label">الرقم:</span><span class="id-value">${member.member_id}</span></div>
            <div><span class="id-label">البطاقة:</span><span class="id-value">${member.membership_card_number}</span></div>
            <div><span class="id-label">العمر:</span><span class="id-value">${age} سنة</span></div>
            <div><span class="id-label">النشاط:</span><span class="id-value">${member.selected_activity}</span></div>
          </div>
        </div>
        <div class="id-footer">صالحة للموسم 2024-2025</div>
      </div>
    </body>
    </html>
  `;
