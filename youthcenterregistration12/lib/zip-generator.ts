...
function generateAdminReceiptHtml(member: Member): string {
  const getPhotoHtml = () => {
    ...
    return `<img src="documents/images/photo.jpg" alt="صورة المنخرط" class="photo" onerror="this.style.display='none'">`
  }
...
function generateMembershipCardHtml(member: Member): string {
  ...
  const getPhotoHtml = () => {
    ...
    return `<img src="documents/images/photo.jpg" alt="صورة المنخرط" style="width: 100%; height: 100%; object-fit: cover;" onerror="this.parentElement.innerHTML='<div style=\\"display: flex; align-items: center; justify-content: center; height: 100%; color: #666; font-size: 10px; font-weight: bold;\\">صورة</div>'">`
  }
